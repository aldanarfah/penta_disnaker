...
const dummyData: DataDisabilitas[] = [
  {
    id: 1,
    namaLengkap: "Yanto",
    nik: "3547109872998765",
    jenisKelamin: "Laki-laki",
    tempatLahir: "Lumajang",
    tanggalLahir: "30/07/2002",
    alamat: "Desa Jatian No.16 Kecamatan Kunir, Lumajang",
    provinsi: "Jawa Timur",
    kabupatenKota: "Lumajang",
    noTelepon: "085123456789",
    email: "Yanto@gmail.com",
    statusPekerjaan: "Bekerja",
    namaPerusahaan: "Makmur Jaya",
    tmt: "01/08/2021",
    jabatan: "Staff",
  ...
  return (
    <div className="space-y-5 pb-10">
      ...
      <div className="flex items-end justify-between gap-4 flex-wrap">
        <div>
            <h1 className="text-2xl font-black text-gray-900">Daftar Tenaga Kerja Lansia</h1>
